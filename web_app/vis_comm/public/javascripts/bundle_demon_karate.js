...
},{"uuid":222}],3:[function(require,module,exports){
'use strict';
...
// </Raphael.fn.connection>
},{"./renderer":8,"raphael":228}],8:[function(require,module,exports){
'use strict';
...
},{"./v1":225,"./v4":226}],223:[function(require,module,exports){
/**
...
},{"./lib/bytesToUuid":223,"./lib/rng":224}],226:[function(require,module,exports){
var rng = require('./lib/rng');
var bytesToUuid = require('./lib/bytesToUuid');
...
},{"./lib/bytesToUuid":223,"./lib/rng":224}],227:[function(require,module,exports){
/*!
...
$(document).ready(function () {
    ...
    $.getJSON("/demon_karate/comm_result", function (json) {
        iter_res_dict = json;
    ...
    $("#btn_speed_normal_demon_karate").click(function () {
        console.log("Clicked button normal, vis time:" + vis_time);
        vis_time = 2000;
    });

    $("#btn_speed_fast_demon_karate").click(function () {
        vis_time = vis_time / 2;
        console.log("Clicked button fast, vis time:" + vis_time);
    });

    $("#btn_speed_slow_demon_karate").click(function () {
        vis_time = vis_time * 2;
        console.log("Clicked button slow, vis time:" + vis_time);
    });

    $("#btn_pause_demon_karate").click(function () {
