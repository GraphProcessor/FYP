...
$(document).ready(function () {
    ...
    $.getJSON("/cis_collab/comm_result", function (json) {
        iter_res_dict = json;
    ...
    $("#btn_speed_normal_cis_collab").click(function () {
        console.log("Clicked button normal, vis time:" + vis_time);
        vis_time = 2000;
    });

    $("#btn_speed_fast_cis_collab").click(function () {
        vis_time = vis_time / 2;
        console.log("Clicked button fast, vis time:" + vis_time);
    });

    $("#btn_speed_slow_cis_collab").click(function () {
        vis_time = vis_time * 2;
        console.log("Clicked button slow, vis time:" + vis_time);
    });

    $("#btn_pause_cis_collab").click(function () {
